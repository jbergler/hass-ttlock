<!-- Source: https://euopen.ttlock.com/document/doc?urlName=cloud%2FeletricMeter%2Fadmin%2FupdatePayModeEn.html -->

# **Set payment mode**

`https://api.sciener.com/v3/electricMeter/updatePayMode`
...
```
curl --location -g --request POST 'https://api.sciener.com/v3/electricMeter/updatePayMode'\
...
| payMode | Int | Y | 0 - Energy Metering Mode 1 - Prepaid |
