<!-- Source: https://euopen.ttlock.com/document/doc?urlName=cloud%2FeletricMeter%2Fadmin%2FupdateMaxPowerEn.html -->

# **Set maximum power**

`https://api.sciener.com/v3/electricMeter/updateMaxPower`
...
```
curl --location -g --request POST 'https://api.sciener.com/v3/electricMeter/updateMaxPower'\
--data-urlencode 'clientId=4773aa036f7f49c68d876bb4be85c80c' \
--data-urlencode 'accessToken=dfd5489d0cee31f0bdfaf59d0d42d71f' \
--data-urlencode 'electricMeterId=3001' \
--data-urlencode 'maxPower=100' \
