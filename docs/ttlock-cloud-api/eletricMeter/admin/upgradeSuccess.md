<!-- Source: https://euopen.ttlock.com/document/doc?urlName=cloud%2FeletricMeter%2Fadmin%2FupgradeSuccessEn.html -->

# **Upgrade successful**

`https://api.sciener.com/v3/electricMeter/upgradeSuccess`
...
```
curl --location -g --request POST 'https://api.sciener.com/v3/electricMeter/upgradeSuccess'\
