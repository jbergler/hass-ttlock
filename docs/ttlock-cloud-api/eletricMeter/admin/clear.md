<!-- Source: https://euopen.ttlock.com/document/doc?urlName=cloud%2FeletricMeter%2Fadmin%2FclearEn.html -->

# **Clear the electricity meter**

`https://api.sciener.com/v3/electricMeter/clear`

To clear the electricity meter using the gateway, if Bluetooth operation is required, please refer to the corresponding APP's SDK.
...
```
curl --location -g --request POST 'https://api.sciener.com/v3/electricMeter/clear'\
