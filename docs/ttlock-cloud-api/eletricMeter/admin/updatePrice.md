<!-- Source: https://euopen.ttlock.com/document/doc?urlName=cloud%2FeletricMeter%2Fadmin%2FupdatePriceEn.html -->
...
```
curl --location -g --request POST 'https://api.sciener.com/v3/electricMeter/updatePrice'\
