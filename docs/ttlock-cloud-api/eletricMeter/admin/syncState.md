<!-- Source: https://euopen.ttlock.com/document/doc?urlName=cloud%2FeletricMeter%2Fadmin%2FsyncStateEn.html -->

# Meter reading

`https://api.sciener.com/v3/electricMeter/syncState`

If you need to use Bluetooth to read meters using a gateway, please refer to the corresponding app's SDK.
...
```
curl --location -g --request POST 'https://api.sciener.com/v3/electricMeter/syncState'\
