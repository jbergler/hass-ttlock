<!-- Source: https://euopen.ttlock.com/document/doc?urlName=cloud%2FeletricMeter%2Fadmin%2FupgradeCheckEn.html -->

# Check if the meter firmware needs to be upgraded.

`https://api.sciener.com/v3/electricMeter/upgradeCheck`
...
```
curl --location -g --request POST 'https://api.sciener.com/v3/electricMeter/upgradeCheck'\
...
| --- | --- | --- |
| needUpgrade | Int | Upgrade required: 0 - No, 1 - Yes, 2 - Unknown |
