<!-- Source: https://euopen.ttlock.com/document/doc?urlName=cloud%2Fekey%2FunauthorizeEn.html -->

# Cancel key authorization

**`https://api.sciener.com/v3/key/unauthorize`**
...
```
curl --location -g --request POST 'https://api.sciener.com/v3/key/unauthorize' \
