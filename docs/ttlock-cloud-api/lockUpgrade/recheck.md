<!-- Source: https://euopen.ttlock.com/document/doc?urlName=cloud%2FlockUpgrade%2FrecheckEn.html -->

# Upgrade recheck

**`https://api.sciener.com/v3/lock/upgradeRecheck`**

When `"unkown"` is returned requesting [Upgrade check](https://euopen.ttlock.com/document/doc?urlName=cloud/lockUpgrade/checkEn.html), you have to call [APP SDK](https://euopen.ttlock.com/document/doc?urlName=appSdkV3/androidSdkDemoV3/downloadEn.html) method to get new `lockData`, and request this API to see whether there is any upgrade for a lock.

Notice: Please make sure the `lockData` is from the [APP SDK](https://euopen.ttlock.com/document/doc?urlName=appSdkV3/androidSdkDemoV3/downloadEn.html) method.
...
```
curl --location -g --request POST 'https://api.sciener.com/v3/lock/upgradeRecheck' \
...
| lockData | String | Y | Lock data, get from [APP SDK](https://euopen.ttlock.com/document/doc?urlName=appSdkV3/androidSdkDemoV3/downloadEn.html) |
...
| firmwareInfo | String | Firmware info |
