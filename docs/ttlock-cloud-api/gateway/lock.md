<!-- Source: https://euopen.ttlock.com/document/doc?urlName=cloud%2Fgateway%2FlockEn.html -->

# Lock the lock

**`https://api.sciener.com/v3/lock/lock`**

Lock the lock remotely via [gateway](https://euopen.ttlock.com/document/doc?urlName=userGuide/gatewayEn.html) or [WiFi lock](https://euopen.ttlock.com/document/doc?urlName=userGuide/wifiLockEn.html).
...
```
curl --location -g --request POST 'https://api.sciener.com/v3/lock/lock' \
