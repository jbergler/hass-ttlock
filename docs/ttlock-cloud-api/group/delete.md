<!-- Source: https://euopen.ttlock.com/document/doc?urlName=cloud%2Fgroup%2FdeleteEn.html -->

# Delete Group

**`https://api.sciener.com/v3/group/delete`**

The locks and ekeys will have no group after their group is deleted.
...
```
curl --location -g --request POST 'https://api.sciener.com/v3/group/delete' \
