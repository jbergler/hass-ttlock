<!-- Source: https://euopen.ttlock.com/document/doc?urlName=cloud%2Fgroup%2FrenameEn.html -->

# Rename group

**`https://api.sciener.com/v3/group/update`**
...
```
curl --location -g --request POST 'https://api.sciener.com/v3/group/update' \
--data-urlencode 'clientId=4773aa036f7f49c68d876bb4be85c80c' \
--data-urlencode 'accessToken=dfd5489d0cee31f0bdfaf59d0d42d71f' \
--data-urlencode 'groupId=1342' \
--data-urlencode 'name=3th floor' \
