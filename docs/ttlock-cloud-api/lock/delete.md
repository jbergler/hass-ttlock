<!-- Source: https://euopen.ttlock.com/document/doc?urlName=cloud%2Flock%2FdeleteEn.html -->
...
**Alert：you must [reset the lock via APP SDK](https://euopen.ttlock.com/document/doc?urlName=appSdkV3/androidSdkDemoV3/androidExample/resetLockEn.html) before you request this API，otherwise you'll lose the lockData of the lock, and have to manually reset the lock.**
...
```
curl --location -g --request POST 'https://api.sciener.com/v3/lock/delete' \
