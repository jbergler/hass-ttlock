<!-- Source: https://euopen.ttlock.com/document/doc?urlName=cloud%2FpalmVein%2FrenamePalmVeinEn.html -->

# Rename Palm Vein

`https://api.sciener.com/v3/palmVein/rename`
...
```
curl --location -g --request POST 'https://api.sciener.com/v3/palmVein/rename'\
