<!-- Source: https://euopen.ttlock.com/document/doc?urlName=cloud%2FdoorSensor%2FupgradeSuccessEn.html -->

# Check if upgrade was successful

**`https://api.sciener.com/v3/doorSensor/upgradeSuccess`**
...
```
curl --location -g --request POST 'https://api.sciener.com/v3/doorSensor/upgradeSuccess' \
