<!-- Source: https://euopen.ttlock.com/document/doc?urlName=cloud%2FdoorSensor%2FstandaloneDoorSensor%2FdeleteEn.html -->

# Delete DS3

**`https://api.sciener.com/v3/standaloneDoorSensor/delete`**

Delete the door sensor from the account.
...
```
curl --location -g --request POST 'https://api.sciener.com/v3/standaloneDoorSensor/delete' \
