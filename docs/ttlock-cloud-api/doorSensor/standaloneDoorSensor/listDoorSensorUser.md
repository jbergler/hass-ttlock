<!-- Source: https://euopen.ttlock.com/document/doc?urlName=cloud%2FdoorSensor%2FstandaloneDoorSensor%2FlistDoorSensorUserEn.html -->

# Query the list of users whose DS3 are shared
...
```
curl --location -g --request POST 'https://api.sciener.com/v3/standaloneDoorSensor/listDoorSensorUser' \
