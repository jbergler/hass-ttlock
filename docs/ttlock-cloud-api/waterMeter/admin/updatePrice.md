<!-- Source: https://euopen.ttlock.com/document/doc?urlName=cloud%2FwaterMeter%2Fadmin%2FupdatePriceEn.html -->

# Modify unit price

`https://api.sciener.com/v3/waterMeter/updatePrice`

Water meters in prepaid mode can have their unit price modified.
...
```
curl --location -g --request POST 'https://api.sciener.com/v3/waterMeter/updatePrice'\
