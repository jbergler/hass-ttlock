<!-- Source: https://euopen.ttlock.com/document/doc?urlName=cloud%2FwaterMeter%2Fadmin%2FbindEn.html -->

# Binding water meter

`https://api.sciener.com/v3/waterMeter/bind`

After the water meter is initialized by the APP SDK, this interface is called.
...
```
curl --location -g --request POST 'https://api.sciener.com/v3/waterMeter/bind'\
--data-urlencode 'clientId=4773aa036f7f49c68d876bb4be85c80c' \
--data-urlencode 'accessToken=dfd5489d0cee31f0bdfaf59d0d42d71f' \
--data-urlencode 'mac=11:22:33:44:55:66' \
--data-urlencode 'name=em2_waterMeter' \
