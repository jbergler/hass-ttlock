<!-- Source: https://euopen.ttlock.com/document/doc?urlName=cloud%2FwaterMeter%2Fadmin%2FclearEn.html -->

# Clear water meter

`https://api.sciener.com/v3/waterMeter/clear`

To clear the water meter using the gateway, if Bluetooth operation is required, please refer to the corresponding APP's SDK.
...
```
curl --location -g --request POST 'https://api.sciener.com/v3/waterMeter/clear'\
