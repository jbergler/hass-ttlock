<!-- Source: https://euopen.ttlock.com/document/doc?urlName=cloud%2FwaterMeter%2Fadmin%2FrechargeEn.html -->

# **Administrator recharge**

`https://api.sciener.com/v3/waterMeter/recharge`
...
```
curl --location -g --request POST 'https://api.sciener.com/v3/waterMeter/recharge'\
...
| rechargeAmount | Double | Y | recharge money amount |
| rechargeM3 | Double | Y | recharge water amount |
