<!-- Source: https://euopen.ttlock.com/document/doc?urlName=cloud%2FwaterMeter%2Fadmin%2FsyncStateEn.html -->

# Meter reading

`https://api.sciener.com/v3/waterMeter/syncState`
...
```
curl --location -g --request POST 'https://api.sciener.com/v3/waterMeter/syncState'\
