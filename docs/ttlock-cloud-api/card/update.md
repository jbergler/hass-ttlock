<!-- Source: https://euopen.ttlock.com/document/doc?urlName=cloud%2Fcard%2FupdateEn.html -->

# Change the period of validity of a card
...
You can develop your own APP based on our [APP SDK](https://euopen.ttlock.com/document/doc?urlName=appSdkV3/androidSdkDemoV3/downloadEn.html)，call [Modify a card's validity](https://euopen.ttlock.com/document/doc?urlName=appSdkV3/iosSdkDemoV3/iosExample/cardEn.html) method to change it in the lock, then request this API ( with `changeType=1`) to sync it to cloud.
...
```
curl --location -g --request POST 'https://api.sciener.com/v3/identityCard/changePeriod' \
